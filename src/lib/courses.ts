...
export function getCourseIds(): string[] {
  return [
    ...
    'organic-biodynamic',
    'dessert-wines', 'beer-cider', 'somm-exam-prep',
    'sake-shochu-intro', 'hk-sg-cocktail-etiquette',
    'quick-wine-5min',
    'quick-cocktail-5min',
    'dating-wine-select',
    'quick-whisky-5min',
...
export const COURSE_META: Record<string, { title: string; free: boolean }> = {
  ...
  'sake-shochu-intro': { title: '日韓清酒與燒酎入門', free: false },
  'hk-sg-cocktail-etiquette': { title: '新加坡・香港調酒與法規禮儀', free: false },
