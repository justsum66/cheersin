...
/** B29/B50：Bento 四卡文案可配置（品牌） */
export const BENTO_CARDS = [
  { id: 'quiz' as const, title: '靈魂酒測', description: '30 秒測出你的命定酒款，AI 精準推薦。', badge: '最受歡迎' },
  { id: 'games' as const, title: '派對遊樂場', description: '真心話、國王杯等經典酒桌遊戲；懲罰可自訂，不飲酒也能玩。' },
  { id: 'assistant' as const, title: 'AI 侍酒師', description: '隨時問酒款、搭餐與知識，即問即答。' },
  { id: 'learn' as const, title: '品酒學院', description: '系統化課程，從入門到進階，輕鬆學。' },
] as const
