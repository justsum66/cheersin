...
import { ThumbsUp, ThumbsDown, Copy, Hand, EyeOff, Trophy, Heart, Plus, Timer, Play, Pause } from 'lucide-react'
...
export default function NeverHaveIEver() {
  ...
  const nextCard = useCallback(
    (hasDone: boolean) => {
      ...
      if (hasDone) {
        ...
        // G3-012: Spawn floating particles
        spawnParticles()
      }
  ...
  }, [newQuestionText, customQuestions, setCustomQuestions])
  ...
  const startNewRound = useCallback(() => {
    ...
    if (categoryFilter === 'favorites') {
      ...
      items = getStatementsByCategory(categoryFilter)
