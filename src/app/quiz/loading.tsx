...
/** Quiz 頁 20 項優化 #11、Q-04：測驗頁載入佔位與 Quiz 視覺一致；skeleton 固定尺寸不閃爍、safe-area。R2-290：載入狀態與首屏佈局一致。 */
export default function Loading() {
  return (
    <main role="progressbar" aria-label="測驗載入中" className="min-h-screen quiz-hero-echo pt-12 px-4 pb-16 relative overflow-x-hidden safe-area-px page-container-mobile">
